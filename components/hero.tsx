                ...
                {projectsData.map((project, index) => {
                    ...
                    return (
                        project.page != "" ? 
                            ...
                            <Link className={`group flex flex-row wrap transition h-[11.5rem] min-w-min ${myFilters.includes('all') || myFilters.some((r:string) => project.type.indexOf(r) >= 0) ? 'visible' : 'invisible'} sm:h-12 hover:bg-primary-100 hover:z-10`}
                            ...
                            <div className={`group flex flex-row wrap transition h-[11.5rem] min-w-min cursor-default ${myFilters.includes('all') || myFilters.some((r:string) => project.type.indexOf(r) >= 0) ? 'visible' : 'invisible'} sm:h-12 hover:bg-primary-100 hover:z-10`}
                            onMouseOver= {() => handleMouseOver(project)}
                            onMouseOut={handleMouseOut}>
                                {content}
                            </div>
